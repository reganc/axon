...
class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="AXON_", env_file=".env", extra="ignore")

    # app
    app_name: str = "axon"
    env: str = "dev"
    api_port: int = 8100  # container-internal bind; host maps via AXON_API_PORT (default 4100)
    ...
    ollama_base_url: str = "http://host.docker.internal:11434"  # Ollama on the comet host
    ollama_chat_model: str = "llama3.1:8b"
    ollama_embed_model: str = "nomic-embed-text"
    anthropic_api_key: str = ""
    anthropic_model: str = ""  # set AXON_ANTHROPIC_MODEL to your chosen model id (reason tier)
    embed_dim: int = 768
